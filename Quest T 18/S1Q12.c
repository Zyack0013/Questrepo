...
void pushCommand(CommandStack *s, char *command);
void popCommand(CommandStack *s);
void viewCommands(CommandStack *s);
...
int main() {
    ...
    while (1) {
        ...
        printf("\nSatellite Operation Commands Stack Menu:\n");
...
void popCommand(CommandStack *s) {
    ...
    if (isEmpty(s)) {
        ...
        printf("No commands to pop. The stack is empty.\n");
...
void viewCommands(CommandStack *s) {
    ...
    if (isEmpty(s)) {
        ...
        printf("All commands in the stack:\n");
...
void searchCommand(CommandStack *s, char *command) {
    ...
    if (isEmpty(s)) {
        ...
        printf("No commands in the stack to search.\n");
